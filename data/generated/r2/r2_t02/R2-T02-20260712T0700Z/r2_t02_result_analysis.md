# R2-T02 Result Analysis

Run `R2-T02-20260712T0700Z` froze the confirmed-state and event-zone protocol contract only.
It generated 36 primary cells and
36 shared-q sidecar cells with
