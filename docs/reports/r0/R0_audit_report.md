...
| --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| Raw metrics | R0-T10-01 / R0-T04 | #69 + repair | `docs/evidence/r0/R0-T10-01_r0_t04_raw_metrics_materialization_evidence_repair_20260708T1715Z.md` | R0-T10-01-20260708T1715Z | `9195dfebebe71802c582d4094fbaec2427c46d27` | D3 candidate input manifest | `89ff2979f8e151c1611c0c61b1b547783f76a4ad94953c9252b0ecef98ed56a0` | 13,846,152 | 800 | 20160104-20260630 | R0-T05_allowed_to_start=true |
| Strict-past scores | R0-T10-02 / R0-T05 | #70 + repair | `docs/evidence/r0/R0-T10-02_r0_t05_strict_past_score_materialization_evidence_repair_20260708T1730Z.md` | R0-T10-02-20260708T1730Z | `9195dfebebe71802c582d4094fbaec2427c46d27` | `89ff2979f8e151c1611c0c61b1b547783f76a4ad94953c9252b0ecef98ed56a0` | `6da065875c8270e321910083409f4dba5c1ee63bc6328e56aff3a1d489924447` | 41,538,456 indicator score rows | 800 | 20160104-20260630 | R0-T06_allowed_to_start=true |
| Nested states | R0-T10-03 / R0-T06 | #71 + repair | `docs/evidence/r0/R0-T10-03_r0_t06_nested_state_materialization_evidence_repair_20260708T1740Z.md` | R0-T10-03-20260708T1740Z | `9195dfebebe71802c582d4094fbaec2427c46d27` | `6da065875c8270e321910083409f4dba5c1ee63bc6328e56aff3a1d489924447` | `0c07f4897d76c0a729963118c2e75581bd71521a25245d6d3b650b4f32e68995` | 15,576,921 nested daily rows | 800 | 20160104-20260630 | R0-T07_allowed_to_start=true |
| Confirmation / interval | R0-T10-04 / R0-T07 | #72 + repair | `docs/evidence/r0/R0-T10-04_r0_t07_confirmation_interval_materialization_evidence_repair_20260708T1746Z.md` | R0-T10-04-20260708T1746Z | `4f54efba6cb4525adf2123d87bb56d7ada94cecd` | `0c07f4897d76c0a729963118c2e75581bd71521a25245d6d3b650b4f32e68995` | `e9bcaafbd60229b6d9e01967cedb2739efb3407159a66d1ef47b3d779689b4e3` | 186,923,052 daily confirmation rows; 1,012,396 interval rows | 800 | 20160104-20260630 | R0-T10-05_allowed_to_start=true |
| Authorized manifest and full-grid | R0-T10-05 | #73 + repair | `docs/evidence/r0/R0-T10-05_authorized_input_manifest_full_grid_evidence.md` | R0-T10-05-20260708T1754Z | `e97ce154b174d661f0628c19014485509c022547` | `d18d4841476abb80da804635d15d9b9b853e5fb9e40545288c445be27af713f9` | `b031ae22a3cf396961bcefcf6479c18870b8206a348372cf87d4b9f73c1fd96b` | 186,923,052 daily candidate rows; 1,012,396 interval rows | 800 | 20160104-20260630 | R0-T11_allowed_to_start=true |
...
The formal R0 chain covers security_count = 800 and date range = 20160104 to 20260630. R0-T04 row count is 13,846,152. R0-T05 indicator score row count is 41,538,456, dimension score row count is 20,769,228, and common eligible row count is 1,730,769. R0-T06 nested daily state row count is 15,576,921. R0-T07 daily confirmation row count is 186,923,052 and R0-T07 confirmed interval row count is 1,012,396. R0-T10-05 daily candidate row count is 186,923,052 and R0-T10-05 confirmed interval row count is 1,012,396. The full-grid selected_config_count: 27, completed_config_count: 27, failed_config_count: 0.

## Confirmed Interval Audit

R0-T07 confirmed interval row count = 1,012,396 and R0-T10-05 confirmed interval row count = 1,012,396. R0-T10-05 records confirmed_interval_row_count_total: 1,012,396, daily_confirmed_true_count_total: 10,206,649, confirmed_interval_zero_config_count: 0, and zero_interval_reason_if_any: null. All 27 W/q/K configs have nonzero confirmed intervals.

R1-T01 may profile confirmed interval availability, but R1 must still begin with state existence, frequency, raw/confirmed distributions, validity status, unknown / blocked distributions, exclusive layer distribution, and state sparsity. Confirmed intervals are R1 input facts, not R2 freeze decisions, trading signals, or evidence of tradeable value.
