...
current_sidecar_task: EXP-A03 candidate intralayer formal result review
workflow_mode: long_lived_same_pr
phase: A03_formal_result_review
...
execution_sha: dc4984138f440e28fb87fd0ee6366dd9280b9488
...
EXP-A03_status: formal_result_review_pending
...
EXP-A03_result_review_status: pending
EXP-A03_formal_result_review_status: pending
...
EXP-C01 的正式结果已由用户接受：C1-only 与 C2-only 均未达到预注册 strong-substitutability reference，保留当前 C1+C2 pair，不选择或删除指标，不创建 C v2。EXP-A 不继承 EXP-C01 的 formal-run 授权；EXP-A03 的 formal run 已按独立授权完成并停在 Formal-result review，EXP-A04 仍未启动，下一阶段必须由用户明确授权。
