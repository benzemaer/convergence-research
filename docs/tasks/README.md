...
R3-T01_status: implementation_review
R3-T01_implementation_review_status: pending
R3-T01_reviewed_implementation_sha:
R3-T01_formal_run_allowed: false
R3-T01_formal_run_status: not_started
R3-T01_result_review_status: not_started
R3-T01_next_task_allowed: false
R3-T01_readme_advanced: false
...
状态：implementation_review；R3-T01 尚未完成，T02 未开放

- `R3-T01` 研究协议、T0 与分析单位冻结：implementation review；只冻结协议、T0/T1/T2、horizon 与 split，不生成真实样本或标签
- `R3-T02` 对照路径、标准化与经验边界契约：blocked pending R3-T01 acceptance
