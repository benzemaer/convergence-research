...
R2-T08_scientific_review_status: passed
...
R2-T08_formal_task_completed: true
R2_evidence_chain_status: passed_via_PR_100_merged_direct_binding
R3_handoff_eligible: true
R3_allowed_to_start: true
R3-T01_allowed_to_start: true
R3-T01_status: completed_via_PR_103_accepted
R3-T01_implementation_review_status: approved
R3-T01_reviewed_implementation_sha: 460728eb42fb4464b781a34595f3ad544677c113
R3-T01_formal_run_allowed: true
R3-T01_formal_run_status: completed
R3-T01_formal_execution_sha: 460728eb42fb4464b781a34595f3ad544677c113
R3-T01_formal_result_status: accepted
R3-T01_result_review_status: passed
R3-T01_scientific_review_status: passed
R3-T01_formal_run_executed: true
R3-T01_run_id: R3-T01-20260715T041724Z
R3-T01_formal_artifact_commit: b40cc64146c39de5ba284a1dbc8710bda603dc6f
R3-T01_scientific_review_id: 4700825401
R3-T01_next_task_allowed: true
R3-T01_readme_advanced: true
R3-T02_allowed_to_start: true
R3-T03_allowed_to_start: false
R3-T04_allowed_to_start: false
R3-T05_allowed_to_start: false
R3-T06_allowed_to_start: false
R3-T07_allowed_to_start: false
R3-T08_allowed_to_start: false
R4_allowed_to_start: false
```
...
## R3：收敛区间脱离、经验路径边界与未来路径标签

状态：R3-T01 completed/accepted；当前任务为 R3-T02，已开放

- `R3-T01` 研究协议、T0 与分析单位冻结：completed/accepted via PR #103；只冻结协议、T0/T1/T2、horizon 与 split，不生成真实样本或标签
- `R3-T02` 对照路径、标准化与经验边界契约：authorized after R3-T01 acceptance
- `R3-T03` 五类未来路径与技术状态标签契约：blocked pending R3-T02
- `R3-T04` T0/T1/T2 Landmark 特征与无前视契约：blocked pending R3-T03
- `R3-T05` canonical exit、路径、边界与标签物化：blocked pending R3-T04
- `R3-T06` 路径标签独立复算、稳定性与异常扫描：blocked pending R3-T05
- `R3-T07` 路径本体、边界与最终标签 manifest：blocked pending R3-T06
- `R3-T08` R3 阶段验收与 R4 交接：blocked pending R3-T07
