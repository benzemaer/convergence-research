...
status: score_independent_review_repair_pending_review
...
Authorization revision 3 HEAD `21837edddfcc298b8539bcf9f71a1b7e016b6d47` 已在正式运行前被替代，未使用且未消费 attempt。当前独立 review CLI 修复提交必须先通过精确 HEAD Quality；随后才可创建 metadata-only revision 4。Repair 阶段停止在：
